...
<body>
    <div class="container-fluid">
                         ...
                         <div class="row">
                             <div class="col-md-3"></div>
                                <div class="col-md-6 col-xs-12">
                                    <form action="change_password_bcode.php" method="post" class="form-container shadow-lg p-3 mb-5 bg-body rounded"  >

                                        <div class="form-floating">
                                            <input type="password" name="old_password" class="form-control text-success" id="floatingPassword" placeholder="Password" style="background: transparent; border: none; border-bottom: 2px solid rgb(227, 231, 236);">
                                            <label for="floatingPassword" style="color: red; font-size: 20px;">Old Password</label>
                                        </div>
                                    

                                        
                                        <div class="form-floating">
                                            <input type="password" name="new_password" class="form-control text-success" id="floatingPassword" placeholder="Password" style="background: transparent; border: none; border-bottom: 2px solid rgb(227, 231, 236);">
                                            <label for="floatingPassword" style="color: red; font-size: 20px;">New Password</label>
                                        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                        <div class="alert alert-primary" role="alert">
                            <h6 class="text-center" style="text-decoration: none; font-family: Orbitron;"> copyright &copy; All rights are reserved Jacques Appiagyei and Bernard Andoh 2024</h6>
