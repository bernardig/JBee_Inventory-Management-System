...
if($_SESSION['department']!= "Bpharma"){
    ?>
    <script>
                    ...
                    <div class="row">
                            ...
                            <div class="col-md-10">
                                <table class="table table-bordered table-hover">
                                    <thead>
                                        <tr>
                                        <td colspan="9" style="color:yellow; background-color:green; text-align: center;"><?php echo $_SESSION['department']; ?> PRODUCT LIST</td>
                                        </tr>
                                        <tr>
                                            <th>P. Id</th>
                                            <th>Dept.</th>
                                    ...
                                    <?php
                                        ...
                                        $query = "select * from add_product where department = 'BPharma'";
                                        ...
                                        while($row = mysqli_fetch_assoc($query_run)){
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-success" name=""><a style="text-decoration: none; color: white;"  href="edit_product.php?cid=<?php echo $row['id'];?>">Edit</a></button>
                                                </td>
                                                <td>
                                                    <button class="btn btn-danger" name=""><a style="text-decoration: none; color: white;"  href="delete_product.php?cid=<?php echo $row['id'];?>">Delete</a></button>
                                                </td>
                                            </tr>
                                            <?php
                                        }
