...
<body>
    <div class="container-fluid">
                            ...
                            <div class="col-md-10">
                                <table class="table table-bordered table-hover">
                                    ...
                                    <?php
                                        ...
                                        $query = "select * from add_product where department = 'BSC'";
        ...
        <div class="row">
            <div class="col-md-12">
                        <div class="alert alert-primary" role="alert">
                            <h6 class="text-center" style="text-decoration: none; font-family: Orbitron;"> copyright &copy; All rights are reserved Jacques Appiagyei, Bernard Andoh 2024</h6>
